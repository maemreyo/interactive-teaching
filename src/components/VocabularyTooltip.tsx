// src/components/VocabularyTooltip.tsx
'use client';
...
const VocabularyTooltip: React.FC<VocabularyTooltipProps> = ({ vocabulary, isEnabled }) => {
  ...
  }, [vocabulary, isEnabled, isVisible]);
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium opacity-90">Quick Review</span>
            </div>
            <button
              onClick={handleClose}
