// src/app/cambridge/unit-3/addition/components/PracticePage.tsx
"use client";
...
const generateProblem = (): PracticeProblem => {
  ...
  const num1 = {
    hundreds: Math.floor(Math.random() * 5) + 1,
    tens: Math.floor(Math.random() * 9),
    units: Math.floor(Math.random() * 9)
  };
  const num2 = {
  ...
  const stories = {
    en: [
      `Rabbit has ${num1.hundreds}${num1.tens}${num1.units} carrots. Bear gives ${num2.hundreds}${num2.tens}${num2.units} more carrots. How many carrots does Rabbit have in total?`,
      `There are ${num1.hundreds}${num1.tens}${num1.units} books in the library. ${num2.hundreds}${num2.tens}${num2.units} more books are added. How many books are there in total?`,
      `Class 3A has ${num1.hundreds}${num1.tens}${num1.units} students. Class 3B has ${num2.hundreds}${num2.tens}${num2.units} students. How many students are there in both classes?`
    ],
    vi: [
      `Bạn Thỏ có ${num1.hundreds}${num1.tens}${num1.units} củ cà rốt, bạn Gấu cho thêm ${num2.hundreds}${num2.tens}${num2.units} củ. Hỏi bạn Thỏ có tất cả bao nhiêu củ cà rốt?`,
      `Trong kho có ${num1.hundreds}${num1.tens}${num1.units} quyển sách, người ta mang thêm ${num2.hundreds}${num2.tens}${num2.units} quyển nữa. Hỏi trong kho có tất cả bao nhiêu quyển sách?`,
      `Lớp 3A có ${num1.hundreds}${num1.tens}${num1.units} học sinh, lớp 3B có ${num2.hundreds}${num2.tens}${num2.units} học sinh. Hỏi cả hai lớp có tất cả bao nhiêu học sinh?`
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <motion.div
          className="absolute top-20 left-20 w-32 h-32 bg-purple-400 rounded-full blur-xl"
          animate={{
            x: [0, 100, 0],
            y: [0, -50, 0],
          }}
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-4">
            {language === "en" ? "📝 Addition Practice 📝" : "📝 Luyện Tập Cộng 📝"}
          </h1>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {/* Story Context */}
            <Card className="mb-8 bg-white/90 backdrop-blur-sm border-2 border-purple-200/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-8">
              <div className="text-center">
                <NumberHouse
                  ...
                  label={t.numberHouse.firstNumber}
                  size="large"
                  language={language}
                />
              </div>
              ...
              <div className="text-center">
                <NumberHouse
                  ...
                  label={t.numberHouse.secondNumber}
                  size="large"
                  language={language}
                />
              </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="text-center">
                  <Button
                    ...
                    className="px-12 py-4 text-xl font-bold bg-blue-500 hover:bg-blue-600"
                  >
