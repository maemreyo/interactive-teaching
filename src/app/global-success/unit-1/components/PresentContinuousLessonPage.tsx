// pdf-to-learn/src/app/global-success/unit-1/components/PresentContinuousLessonPage.tsx
'use client';
...
const PresentContinuousLessonPage: React.FC = () => {
  const [currentSlide, setCurrentSlide] = useState(0);

  const slides = [
    { component: IntroductionSlide, title: "Giới thiệu" },
    { component: UsageSlide, title: "Cách sử dụng" },
    { component: AffirmativeFormSlide, title: "Dạng khẳng định" },
    { component: NegativeFormSlide, title: "Dạng phủ định" },
    { component: InterrogativeFormSlide, title: "Dạng nghi vấn" },
    { component: SpellingRulesSlide, title: "Quy tắc -ing" },
    { component: SignalWordsSlide, title: "Dấu hiệu nhận biết" },
    { component: HowToGuideSlide, title: "Hướng dẫn làm bài" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-green-50 to-blue-50">
      ...
      <div className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-lg border-b-2 border-green-100">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-green-800 text-center font-baloo-2">
              Bài học: Thì Hiện Tại Tiếp Diễn
            </h1>
          ...
          <div className="bg-green-200 rounded-full h-3 w-full">
            <motion.div 
...
export default PresentContinuousLessonPage;